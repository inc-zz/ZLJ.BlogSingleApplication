...
using Blogs.Domain.ServiceValidator;
using Blogs.Domain.ServiceValidator.Services;
...
namespace Blogs.Domain.ValueValidator.User
{
    ...
    /// 对象值校验
    /// </summary>
    public class UserLoginValidatorCommand<T> : AbstractValidator<T> where T : UserCommand
    {
        ...
        /// 
        /// </summary>
        public UserLoginValidatorCommand()
        {
